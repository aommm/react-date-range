...
var DateRange = (function (_Component) {
  ...
  _createClass(DateRange, [{
    ...
    value: function setRange(range) {
      ...
      if (!silent) onChange && onChange(range);
    }
  }, {
    key: 'handleSelect',
    ...
    value: function componentWillReceiveProps(newProps) {
      ...
      if (newProps.startDate || newProps.endDate) {
        ...
        var startDate = newProps.startDate ? (0, _utilsParseInputJs2['default'])(newProps.startDate, format) : this.props.startDate;
        var endDate = newProps.endDate ? (0, _utilsParseInputJs2['default'])(newProps.endDate, format) : this.props.endDate;
